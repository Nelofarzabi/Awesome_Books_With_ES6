...
```sh
  cd my-folder
  git clone https://github.com/Nelofarzabi/Awesome_Books_With_ES6.git
```
...
Feel free to check the [issues page](https://github.com/Nelofarzabi/Awesome_Books_With_ES6/issues).
...
This project is [MIT](https://github.com/Nelofarzabi/Awesome_Books_With_ES6/blob/main/LICENSE) licensed.
